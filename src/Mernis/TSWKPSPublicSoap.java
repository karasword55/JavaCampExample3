...
public class TSWKPSPublicSoap
{
    ...
    public TSWKPSPublicSoap(){}

    public TSWKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public TSWKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        TSWExtendedSoapSerializationEnvelope envelope= new TSWExtendedSoapSerializationEnvelope(TSWExtendedSoapSerializationEnvelope.VER11);
