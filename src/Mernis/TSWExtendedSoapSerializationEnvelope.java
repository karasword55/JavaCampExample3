...
public class TSWExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(TSWDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new TSWStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static TSWDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static TSWDateTimeConverter dateTimeConverter = new TSWStandardDateTimeConverter();

    public TSWExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public TSWExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new TSWMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=TSWHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,TSWExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=TSWHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
